package com.pikachu.wallpaper.util.gaussian;
...
public class Gaussian {
    ...
    public static Bitmap gaussianApi(Context context, Bitmap image, float blurRadius,float sf) {
     ...
     * @return
     */
    public static Bitmap doBlur(Bitmap sentBitmap,@IntRange(from =  0,to = 100) int radius) {
